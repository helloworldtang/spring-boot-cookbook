 ...
 * @author: tangcheng
 * @description:
 * @since: Created in 2018/06/29 20:00
 */
public class Graphics2DDemo {
    ...
    public void init() {
        // 背景图
        backgroundImgPath = "image/bg.png";
        // 内容图
        contentImgPath = "image/sm.png";
        // 头像
    ...
    public void drawImage() {
        try {
            ...
            // 目标输出文件
            File destFile = new File("result.png");
    ...
    public void step1() {
        try {
            ...
            g.dispose();
            ImageIO.write(img, "png", new File("image/1.png"));
            System.out.println("生成成功！");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void step2() {
        try {
            ...
            g2.drawImage(bi1, 0, 0, bi1.getWidth(), bi1.getHeight(), null);
            g2.dispose();
            ImageIO.write(image, "png", new File("image/2.png"));
            System.out.println("生成成功！");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void step3() {
        try {
            ...
            BufferedImage bg = ImageIO.read(new File("image/1.png"));
            BufferedImage p = ImageIO.read(new File("image/2.png"));
            ...
            g.dispose();
            ImageIO.write(img, "png", new File("image/3.png"));
            System.out.println("生成成功！");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void step4() {
        try {
            ...
            BufferedImage bg = ImageIO.read(new File("image/3.png"));
            BufferedImage avatar = ImageIO.read(new URL(avatarUrl));
            ...
            g.dispose();
            ImageIO.write(img, "png", new File("image/4.png"));
            System.out.println("生成成功！");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void step5() throws IOException {
        try {
            BufferedImage bg = ImageIO.read(new File("image/4.png"));
            ...
            ImageIO.write(bg, "png", new File("image/5.png"));
            System.out.println("生成成功！");
        } catch (IOException e) {
            e.printStackTrace();
        }
